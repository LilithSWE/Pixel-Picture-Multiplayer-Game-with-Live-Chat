...
export default function startPage() {
    ...
    headlineH2.classList.add("text-center", "font-normal", "text-4xl", "leading-9", "tracking-[.3em]", "not-italic", "font-slab"); //TAILWIND CLASSES
    ...
    //TAILWIND CLASSES
    ruleSymbol1.classList.add("font-slab", "font-normal", "text-4xl", "leading-9", "not-italic", "text-center");
    ruleSymbol2.classList.add("font-slab", "font-normal", "text-4xl", "leading-9", "not-italic", "text-center");
    ruleSymbol3.classList.add("font-slab", "font-normal", "text-4xl", "leading-9", "not-italic", "text-center");
    ...
    rule2.classList.add("font-slab", "font-normal", "text-xl", "leading-9", "opacity-90", "text-black", "text-center");
    rule3.classList.add("font-slab", "font-normal", "text-xl", "leading-9", "opacity-90", "text-black", "text-center");
    ...
    */
    ...
    mainContainer.append(img, headlineH2, ruleSymbol1, rule1, ruleSymbol2, rule2, ruleSymbol3, rule3, startPageBtnContainer, savedGamesContainer); // Puts the button container and all the chatrooms in container for all content
}